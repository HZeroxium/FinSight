...
async def register_with_eureka() -> Dict[str, Any]:
    """
...
async def deregister_from_eureka() -> Dict[str, Any]:
    """
...
async def re_register_with_eureka() -> Dict[str, Any]:
    """
...
@router.get("/config")
async def get_eureka_config() -> Dict[str, Any]:
    """
